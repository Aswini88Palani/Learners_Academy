...
public class AssignStudent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("assignStudentToClass.jsp").include(request, response);
        out.println("<h2 style=color:black>Student is Assigned to a Class successfully!</h2>");
	}
